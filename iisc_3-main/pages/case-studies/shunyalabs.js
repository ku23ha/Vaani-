...
export default function ShunyaLabsCaseStudyData() {
    ...
    const {metadata, header} = shunyalabsCaseStudyData;
    ...
    return (
        <>
            <Head>
                ...
                <meta 
                name="description" 
                content={`Learn how ${metadata.companyName} achieved breakthrough results in zero-shot cross-lingual voice conversion using the Vaani dataset. ${header.subtitle}`}
                />
                <meta name="keywords" content="Voice Conversion, Zero-Shot VC, Cross-Lingual VC, Vaani dataset, SpringLab, IIT Madras, Machine Learning" />
                {/* Open Graph */}
            ...
            <div className="bg-slate-50">
                ...
                <CaseStudy caseStudyData={shunyalabsCaseStudyData} />
                <CaseStudiesFooter />
            </div>
        </>
    );
