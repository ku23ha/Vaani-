...
export default function SpringLabCaseStudyPage() {
    ...
    const {metadata, header} = springlabCaseStudyData;
    ...
    return (
        <>
            ...
            <div className="bg-slate-50">
                ...
                <CaseStudy caseStudyData={springlabCaseStudyData} />
                <CaseStudiesFooter />
            </div>
        </>
    );
